                                  ...
                                  Expanded(
                                    child: Column(
                                      children: [
                                        ...
                                        Align(
                                          child: Text("Origine : ${producteur.origine}",
                                              style: TextStyle(
                                                  color: Color.fromRGBO(
                                                      50, 50, 93, 1),
                                                  fontSize: 18.0,
                                        ...
                                        SizedBox(height: 5.0),
                                        Align(
                                          child: Text("Coopérative : ${producteur.cooperative}",
                                              style: TextStyle(
                                                  color: Color.fromRGBO(
                                                      50, 50, 93, 1),
                                                  fontSize: 18.0,
                                        ...
                                        SizedBox(height: 5.0),
                                        Align(
                                          child: Text("Section : ${producteur.section}",
                                              style: TextStyle(
                                                  color: Color.fromRGBO(
                                                      50, 50, 93, 1),
                                                  fontSize: 18.0,
