...
class DetailCooperative extends StatelessWidget {
  final Cooperative cooperative;

  DetailCooperative(this.cooperative);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: Navbar(
          title: "${cooperative.user.username}",
          // title: "Profile",
          transparent: true,
        ),
                                      ...
                                      children: [
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            Column(
                                              children: [
                                                Text("${cooperative.totalProducteurs}",
                                                    style: TextStyle(
                                        ...
                                        SizedBox(height: 5.0),
                                        Align(
                                          child: Text("Contacts : ${cooperative.contacts}",
                                              style: TextStyle(
                                                  color: Color.fromRGBO(
                                                      50, 50, 93, 1),
                                                  fontSize: 18.0,
                                        ...
                                        Align(
                                          child: Text("Région : ${cooperative.region.libelle}",
                                              style: TextStyle(
                                                  color: Color.fromRGBO(
                                                      50, 50, 93, 1),
                                                  fontSize: 18.0,
