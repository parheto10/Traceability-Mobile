...
class Navbar extends StatefulWidget implements PreferredSizeWidget {
  ...
  final double _prefferedHeight = 115.0;
                ...
                if (widget.searchBar)
                  Padding(
                    ...
                    child: Input(
                        ...
                        suffixIcon:
                            Icon(Icons.search_sharp, color: ArgonColors.muted),
                        // onTap: (value) {
                        //   fetchParcelle = fetchParcelle.where((element) => element.contains(value)).toList();
                        // }
                        onTap: () {
                        }
                    ),
